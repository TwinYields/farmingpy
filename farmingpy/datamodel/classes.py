...
#   timestamp: 2025-11-18T14:15:03+00:00
...
class SoilProfileLayer(BaseModel):
    agriparcel: Optional[str] = Field(None, description='Reference to the AgriParcel')
    ...
    soil_c_to_n_ratio: Optional[Any] = Field(
        None,
    ...
    soil_clay_fraction: Optional[float] = Field(
    ...
    soil_critical_air_content_for_roots: Optional[Any] = Field(
        None,
    ...
    soil_layer_base_depth: Optional[float] = Field(
        None, description='Soil layer base depth'
    )
    soil_layer_top_depth: Optional[float] = Field(
    ...
    soil_organic_c_perc_layr: Optional[float] = Field(
        None, description='Total soil organic carbon by layer'
    )
    soil_organic_matter_fraction: Optional[Any] = Field(
        None,
        description='Initial organic matter fraction in soil, OM kg/soil kg, definition from WOFOST',
    )
    soil_organic_matter_perc_layer: Optional[Any] = Field(
    ...
    soil_profile_id: Optional[Any] = Field(None, description='Soil profile identifier')
    soil_sand_fraction: Optional[float] = Field(
        None,
        description='Soil texture, sand (0.05 to 2.0 mm), weight percent of fine earth',
    )
    soil_silt_fraction: Optional[float] = Field(
        None,
    ...
    soil_water_field_cap_1: Optional[float] = Field(
        None, description='Soil water content at 1/3 atmosphere pressure'
    )
    soil_water_field_cap_2: Optional[float] = Field(
    ...
    soil_water_saturated: Optional[float] = Field(
    ...
    soil_water_wilting_pt: Optional[float] = Field(
        None,
...
class Simulation(BaseModel):
    N_uptake_during_season: Optional[Any] = Field(
        None, description='N uptake during season'
    )
    agriparcel: Optional[Any] = Field(None, description='Reference to the AgriParcel')
    anthesis_date: Optional[Any] = Field(
        None, description='Growth stage date, anthesis'
    )
    emergence_date: Optional[Any] = Field(
        None, description='Growth stage date, emergence'
    )
    grain_protein_concentration: Optional[Any] = Field(
        None, description='Grain protein concentration'
    )
    harvest_yield_harvest_dw: Optional[Any] = Field(
    ...
    leaf_area_index_maximum: Optional[Any] = Field(
        None, description='Leaf area index, maximum'
    )
    physiologic_maturity_dat: Optional[Any] = Field(
        None, description='Growth stage of physiol. maturity, as date'
    )
    total_biomass_dry_wt: Optional[Any] = Field(
        None, description='Total biomass without senesced material (dry weight)'
    )
    total_crop_wt_w_senesced: Optional[Any] = Field(
        None, description='Tops+roots+storage+senesced tissue (dry weight)'
    )
    transpiration_cumulative: Optional[Any] = Field(
        None, description='Transpiration, cumulative over season'
    )
    type: Any = Field(..., description='nglsi-id type, has to be Simulation')
